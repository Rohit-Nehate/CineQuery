...
const handleButtonClick = (e)=>{
   ...
   const message =  loginValidation(emailRef.current.value, passwordRef.current.value);
...
{errMessage && <p className="text-red-700 font-bold">{errMessage}</p>}
    
      <button className="bg-[#147ff8] cursor-pointer hover:bg-[#045ec5] text-white p-4! rounded-lg"
