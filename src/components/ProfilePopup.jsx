...
<span>
 <button onClick={handlePofilePopup} className='p-1! cursor-pointer w-full text-center hover:bg-[#6c006e] bg-[#8b0098] text-[#ffffff] border rounded'>
...
<span>
    ...
    <button onClick={handleLogout} className='p-1! w-full text-center cursor-pointer hover:bg-blue-700 bg-blue-500 text-[#ffffff] border rounded'>
