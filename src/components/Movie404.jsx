    ...
    <div className="relative min-h-screen w-full bg-black overflow-hidden flex flex-col items-center justify-center text-white font-sans selection:bg-red-600 selection:text-white">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4">
        ...
        <h1 className="text-9xl font-black tracking-tighter mb-2 relative">
          ...
          <span className="relative inline-block animate-flicker delay-75 text-red-600">0</span>
          <span className="relative inline-block animate-flicker delay-150">4</span>
        </h1>
        ...
        <p className="text-gray-400 max-w-md text-lg mb-8 leading-relaxed">
          Cut! The scene you're looking for didn't make the final edit. 
          It might have been deleted by the director.
        </p>
<Link to="/browse"><div className="group flex items-center mt-5! justify-center gap-2 px-8! py-3! rounded-full bg-red-600 text-white font-semibold hover:bg-red-700 hover:shadow-[0_0_20px_rgba(220,38,38,0.5)] transition-all duration-300">
