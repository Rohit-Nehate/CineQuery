...
<div className='flex justify-between gap-5 items-center'>
   <span onClick={handleShowProfile} className=' text-[#dadfff] flex  items-center cursor-pointer hover:text-white'>
    <i className="ri-user-2-fill text-[#dadfff] text-2xl"></i> {user.displayName}
    <i className={`${showProfile?'ri-arrow-up-s-fill':'ri-arrow-down-s-fill'} text-2xl`}></i>
    </span>
